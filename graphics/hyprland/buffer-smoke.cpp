...
int main() {
    ...
    try {
        ...
        try {
            Hyprland::HybrisBuffer invalid(display, 0, 64);
        ...
        for (int round = 0; round < 10; ++round) {
          {
            Hyprland::HybrisBuffer buffer(display, 64, 64);
        ...
        std::puts("PASS: Hyprland native-buffer foundation, 1200 vendor-render/fence/readback cycles, stable fds, invalid geometry/fence rejected");
