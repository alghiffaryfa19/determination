...
# PID values are not timeout values: Linux can legitimately allocate PIDs
# above the old 60000 timeout parser cap.
sed -i 's/^owner_pid=.*/owner_pid=70000/' "$FIXTURE/aurora/run/audio-owner.state"
# shellcheck disable=SC2086 -- fixture paths contain no whitespace.
