...
apply aquamarine a19cf76ee1a15c1c12083fa372747ce46387289f aquamarine-port.patch
...
cp "$PATCHES/../HybrisBuffer.cpp" "$PATCHES/../HybrisBuffer.hpp" \
    ...
    "$PATCHES/../HwcPresenter.hpp" "$PATCHES/../HwcSession.hpp" \
    "$SRC/aquamarine/src/dethyprland/"
