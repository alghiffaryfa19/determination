 ...
 * guest lifecycle; aurorad and the guest compositor remain independent.
 */
class ExternalDisplayService : Service() {
    companion object {
        private const val TAG = "AuroraExternalService"
        private const val NOTIFICATION_CHANNEL = "aurora-external-display"
        private const val NOTIFICATION_ID = 0x0DE8
        const val ACTION_START = "com.aurora.action.START_EXTERNAL_DISPLAY"
        const val ACTION_STOP = "com.aurora.action.STOP_EXTERNAL_DISPLAY"
