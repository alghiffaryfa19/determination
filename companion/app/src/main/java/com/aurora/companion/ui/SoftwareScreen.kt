...
import androidx.compose.ui.unit.dp
import com.aurora.companion.CATALOG
...
@Composable
private fun DistroSection(vm: AuroraViewModel) {
...
@Composable
private fun CatalogSection(vm: AuroraViewModel) {
    Column(verticalArrangement = Arrangement.spacedBy(10.dp)) {
...
@Composable
private fun InstallButton(vm: AuroraViewModel, pkg: String, label: String = "Install") {
